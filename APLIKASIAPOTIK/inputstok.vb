...
Public Class inputstok

    Private Sub inputstok_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        '// awal jika tombol edit di search peminjam ditekan
        If tampung = 1 Then
            cmd.CommandText = "update stokobat set nama='" & TextBox1.Text & "',jenis='" & ComboBox1.Text & "',harga='" & TextBox2.Text & "',jumlah='" & TextBox3.Text & "' where kode='" & TextBox5.Text & "'"
        End If
        '// akhir
